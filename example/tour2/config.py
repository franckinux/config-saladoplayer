...
panorama_hotspot_2_3 = PanoramaHotspot(panorama=panorama_3, pan=25, tilt=3, show_information=False)
panorama_hotspot_3_1 = PanoramaHotspot(panorama=panorama_1, pan=13, tilt=9, show_information=True)
