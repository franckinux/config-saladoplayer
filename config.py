...
from model import GalleryHotspot, InformationHotspot, PanoramaHotspot, LinkHotspot
...
panorama_1 = Panorama(
    ...
    photo_hotspots=[photo_1]
)

panorama_2 = Panorama(
    directory="repertoire_2",
    title="Panorama 2",
    photo_hotspots=[photo_2],
...
panorama_3 = Panorama(
    ...
    title="Panorama 3",
    photo_hotspots=[photo_2, photo_3],
